...
import com.hostpital.hospitaladmin.Adapters.EmergencyAcceptAdapter;
import com.hostpital.hospitaladmin.Models.Emergency2;
...
public class AcceptEmergencyFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public AcceptEmergencyFragment() {
    }

    public static AcceptEmergencyFragment newInstance() {
        AcceptEmergencyFragment fragment = new AcceptEmergencyFragment();
        return fragment;
    }
...
//        return inflater.inflate(R.layout.fragment_show_requests, container, false);
        ...
        mMainView = inflater.inflate(R.layout.fragment_accept_emergency, container, false);
