...
import com.hostpital.hospitaladmin.Adapters.ActiveRequestAdapter;
...
//        getActivity().overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
        ...
        adapter = new ActiveRequestAdapter(getActivity(), userRequestsListList);
