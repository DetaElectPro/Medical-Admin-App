            ...
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0) {
                    ...
                    if (locationAccepted && readAccepted && writeAccepted)
                        Toast.makeText(Login1Activity.this, "Permission Granted", Toast.LENGTH_LONG).show();
//                        Snackbar.make(view, "Permission Granted, Now you can access location data and camera.", Snackbar.LENGTH_LONG).show();
                    else {
                        Toast.makeText(Login1Activity.this, "Permission Denied", Toast.LENGTH_LONG).show();
    ...
    private void login() {
        if (new InternetConnection().isInternetOn(Login1Activity.this)) {
            ...
            try {
                ...
                object.put("role", "medical_director");
...
//                        if (response.getString("error").matches("Unauthorized")) {
