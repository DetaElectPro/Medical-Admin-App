...
import com.hostpital.hospitaladmin.Activities.ShowActiveRequestsDetailActivity;
...
public class ActiveRequestAdapter extends RecyclerView.Adapter<ActiveRequestAdapter.AdminRequestViewHolder> {
    ...
    public ActiveRequestAdapter(Context context, List<UserRequests> feedsList) {
    ...
    public AdminRequestViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.mLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, ShowActiveRequestsDetailActivity.class);
