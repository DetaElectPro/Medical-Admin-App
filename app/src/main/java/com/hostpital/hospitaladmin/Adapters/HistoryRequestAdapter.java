...
import com.hostpital.hospitaladmin.Activities.ShowHistoryRequestsDetailActivity;
...
public class HistoryRequestAdapter extends RecyclerView.Adapter<HistoryRequestAdapter.AdminRequestViewHolder> {
    ...
    public HistoryRequestAdapter(Context context, List<UserRequests> feedsList) {
