...
import com.hostpital.hospitaladmin.Adapters.EmergencyRequestAdapter;
import com.hostpital.hospitaladmin.Models.Emergency;
...
public class ShowMyEmergencyRequestsFragment2 extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public ShowMyEmergencyRequestsFragment2() {
    }

    public static ShowMyEmergencyRequestsFragment2 newInstance() {
        ShowMyEmergencyRequestsFragment2 fragment = new ShowMyEmergencyRequestsFragment2();
        return fragment;
    }
...
//        return inflater.inflate(R.layout.fragment_show_requests, container, false);
        ...
        mMainView = inflater.inflate(R.layout.fragment_show_my_emergency_requests2, container, false);
